...
public class OptionPanelQuickWalk extends OptionPanelAdapter
  ...
  public String generateCode()
  {
    ...
    result.append(Indentation.indent(Parameter.getClassName() + " model = new "
        + Parameter.getClassName() + "();"));
    result.append(Indentation
        .indent("QuickTester tester = new QuickTester(model);"));
  ...
  public String generateImportLab()
  {
    StringBuffer result = new StringBuffer();
    result.append(Indentation
        .indent("import nz.ac.waikato.modeljunit.QuickTester;"));
    return result.toString();
  }
