...
public class JUNGHelper {
    ...
    /**
     * This will set the edge transition display value. This was implemented because the JUNG graph has limited ability
    ...
    public Layout<Object, Object> getLayout(LayoutType type) {
        if (g.getVertexCount() > 0) {
            switch (type) {
            case CIRCLE:
                return new CircleLayout<Object, Object>(g);
            case FR:
                return new FRLayout2<Object, Object>(g);
            case SPRING:
                return new SpringLayout<Object, Object>(g, UNITLENGTHFUNCTION);
            case KK:
                return new KKLayout<Object, Object>(g);
            case ISOM:
                return new ISOMLayout<Object, Object>(g);
            default:
                return new FRLayout2<Object, Object>(g);
            }
        } else {
    ...
    public void visitedEdge(Transition trans, boolean failed, String failedMsg) {
        if (!edges.containsKey(trans)) {
            ...
            EdgeInfo edge = new EdgeInfo(trans, (VertexInfo) vertices.get(trans.getStartState()), (VertexInfo) vertices
                            .get(trans.getEndState()), true, true);
