...
/**
 * ColorTreeNode extends DefaultMutableTreeNode. Tree nodes are rendered into different colors depends on whether the
 * nodes are in the current sequence or not.
 * 
 * @author Celia Lai
 */
